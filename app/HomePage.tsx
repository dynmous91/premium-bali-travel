  ...
  return (
    <main>
      ...
      <header className="site-header">
        ...
        <a className="button button-dark header-cta" {...whatsappLinkProps(wa)}>{copy.cta}</a>
